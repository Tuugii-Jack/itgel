...
function NavLink({
  ...
  const className =
    "flex items-center gap-2 rounded-[10px] px-4 py-2.5 text-[16px] font-semibold text-ink no-underline transition-colors hover:bg-primary-soft hover:text-primary lg:gap-2.5 lg:px-5 lg:py-3 lg:text-[18px] xl:px-6 xl:py-3.5 xl:text-[19px]";
  const iconEl = (
    <svg
      width='22'
      height='22'
